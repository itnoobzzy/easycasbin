...
type InitDB struct {
	DBType   string `form:"db_type" json:"db_type"`                       // 数据库类型
	Host     string `form:"host" json:"host" default:"127.0.0.1"`         // 服务器地址
	Port     string `form:"port" json:"port" default:"3306"`              // 数据库连接端口
	Username string `form:"username" json:"username"  binding:"required"` // 数据库用户名
	Password string `form:"password" json:"password"`                     // 数据库密码
	DBName   string `form:"db_name" json:"db_name"  binding:"required"`   // 数据库名
}
